...
CREATE TABLE `stocks` (
  ...
  `listed_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '上市时间',
...
) ENGINE=InnoDB AUTO_INCREMENT=77797 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='红利、派息';
